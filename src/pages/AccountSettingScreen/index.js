  ...
  return (
    <View style={styles.PrivacyPolicy}>
      <View style={styles.Group642}>
        ...
        />
        <Text style={styles.Txt432}>Account Setting</Text>
      </View>
      ...
      <View style={{ flexDirection: 'row', marginTop: 20, marginHorizontal: 10 }} onTouchEnd={() => navigation.navigate('EditProfile')}>
        <Image source={require('./i_face.png')} />
        <Text style={{ color: 'white', alignSelf: 'center', marginLeft: 30 }}>Face Recognition</Text>
        <Image source={require('./i_right.png')} style={{ position: 'absolute', right: 0 }} />
      </View>
      <View style={{ flexDirection: 'row', marginTop: 20, marginHorizontal: 10 }} onTouchEnd={() => navigation.navigate('FriendsList')}>
        <Image source={require('./i_contact.png')} />
        <Text style={{ color: 'white', alignSelf: 'center', marginLeft: 30 }}>Contact Information</Text>
        <Image source={require('./i_right.png')} style={{ position: 'absolute', right: 0 }} />
      </View>
      <View style={{ position: 'absolute', bottom: 70, left: 20, backgroundColor: '#1455F5', borderRadius: 20, paddingHorizontal: 30, paddingVertical: 10, width: '100%' }} onTouchEnd={() => navigation.goBack()}>
